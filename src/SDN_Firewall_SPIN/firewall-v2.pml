...
/*message type define*/
mtype = {hello,feat_req,feat_rpl,ptdesc_req,ptdesc_rpl,fm01,fm02,
fm03,data,pkt_in,pkt_out,flow_mod,pkt_drop};
...
creceive:
	...
	::s0_c?mtp,recvmsg->
		...
		::recvmsg.srcIP<N && recvmsg.inport<N ->
			...
			::recvmsg.dstIP>=N->
				atomic{
				IPP[recvmsg.srcIP].b[recvmsg.dstIP]=1;
				IPP[recvmsg.dstIP].b[recvmsg.srcIP]=1;
				recvmsg.fwdPort=N;
				c_s0!flow_mod,recvmsg;
				c_s0!pkt_out,recvmsg;
				}
